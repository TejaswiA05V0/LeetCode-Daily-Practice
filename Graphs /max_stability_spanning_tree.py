# Problem: Maximum Stability of a Network (Spanning Tree Variant)
# Platform: LeetCode
# Difficulty: Hard
# Topic: Graphs, DSU (Union-Find), Binary Search, Greedy
# Time Complexity: O(E log S)
...
class Solution:
    def maxStability(self, n: int, edges: List[List[int]], k: int) -> int:
        ...
        for u, v, s, must in mustEdges:
            if dsuInit.find(u) == dsuInit.find(v):
                return -1
            dsuInit.join(u, v)
            selectedInit += 1
